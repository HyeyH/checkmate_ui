...
################################################################################
## Form generated from reading UI file 'split_dialogTqYgbb.ui'
##
...
class Ui_split_dialog(object):
    def setupUi(self, split_dialog):
        ...
        split_dialog.setStyleSheet(u"#split_dialog{\n"
                                   ...
                                   "	color: #313a46;\n"
                                   "}\n"
                                   "#split_button QPushButton:hover{\n"
                                   "	color:  #fff;\n"
                                   "}")
        ...
        self.split_button.setGeometry(QRect(200, 320, 121, 51))
        font2 = QFont()
